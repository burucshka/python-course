...
window = Tk()
# заголовок окна
window.title('Регистрация пользователя')
# размер окна
...
main_label = Label(window, text='Регестрация пользователя', font=font_header, justify=CENTER, **header_padding)
# помещаем виджет в окно по принципу один виджет под другим
main_label.pack()
# метка для поля ввода имени
username_label = Label(window, text='ФИО', font=label_font , **base_padding)
username_label.pack()
# поле ввода имени
username_entry = Entry(window, bg='#fff', fg='#900', font=font_entry)
username_entry.pack()
# метка для поля ввода пароля
email = Label(window, text='Email', font=label_font , **base_padding)
email.pack()
# поле ввода пароля
password_entry = Entry(window, bg='#fff', fg='#900', font=font_entry)
password_entry.pack()
